...
const CreatePersona: React.FC<CreatePersonaProps> = ({ onCreate }) => {
  ...
  <div className="max-w-4xl mx-auto">
    <h2 className="ml-3 mt-3 text-xl font-bold text-gray-900">Crear una nueva persona</h2>
    <form onSubmit={handleSubmit} className="p-4 border rounded bg-gray-100 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        <h3 className="text-lg font-bold mb-3">Datos de Persona</h3>
        <div>
          <label htmlFor="idPersona" className="block font-medium">Cédula Cliente</label>
          <input
            type="text"
            id="idPersona"
            name="idPersona"
        ...
        <div>
          <label htmlFor="nombre" className="block font-medium mt-4">Nombre</label>
          <input
            type="text"
            id="nombre"
            name="nombre"
        ...
        <div>
          <label htmlFor="apellido1" className="block font-medium mt-4">Apellido 1</label>
          <input
            type="text"
            id="apellido1"
            name="apellido1"
        ...
        <div>
          <label htmlFor="apellido2" className="block font-medium mt-4">Apellido 2</label>
          <input
            type="text"
            id="apellido2"
            name="apellido2"
        ...
        <div>
          <label htmlFor="fechaNacimiento" className="block font-medium mt-4">Fecha de Nacimiento</label>
          <input
            type="date"
            id="fechaNacimiento"
        ...
        <div>
          <label htmlFor="numeroTelefono" className="block font-medium mt-4">Número de Teléfono</label>
          <input
            type="text"
            id="numeroTelefono"
            name="numeroTelefono"
        ...
        <div>
          <label htmlFor="numeroCelular" className="block font-medium mt-4">Número de Celular</label>
          <input
            type="text"
            id="numeroCelular"
            name="numeroCelular"
        ...
        <div>
          <label htmlFor="email" className="block font-medium mt-4">Correo Electrónico</label>
          <input
            type="email"
            id="email"
            name="email"
      ...
      <div>
        ...
        <div>
          <label htmlFor="Provincia" className="block font-medium mt-4">Provincia</label>
          <input
            type="text"
            id="Provincia"
            name="Provincia"
        ...
        <div>
          <label htmlFor="Canton" className="block font-medium mt-4">Cantón</label>
          <input
            type="text"
            id="Canton"
            name="Canton"
        ...
        <div>
          <label htmlFor="Distrito" className="block font-medium mt-4">Distrito</label>
          <input
            type="text"
            id="Distrito"
            name="Distrito"
